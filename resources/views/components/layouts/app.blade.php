		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav m-auto mb-2 mb-lg-0">
					...
					<li class="nav-item "> <a class="nav-link" href="{{route('teams')}}" wire:navigate>Our Team</a></li>
				...
				<a href="{{route('contact-us')}}" class="btn btn-outline-primary" wire:navigate>Contact Us</a>				
			</div>
		</div>
	</nav>
</header>
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						...
						<li class="mb-2"><a href="{{route('service-details',$service->id)}}" wire:navigate>{{$service->title}}</a>
						</li>
						@endforeach
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						...
						<li class="mb-2"><a href="{{route('blogs')}}" wire:navigate>Blog</a>
						</li>
						<li class="mb-2"><a href="/teams" wire:navigate>Team</a>
						</li>
					</ul>
				</div>
			</div>
